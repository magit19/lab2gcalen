...
def main():
    ...
    for r in range(3,39):
        ...
        day = 2 + (r-3)//6
        if para:
            print(day,"сент",start[(r-3)%6],end[(r-3)%6],para,l_pr,room)
            event = {
              'summary': para,
              'location': room,
              'description': l_pr,
            ...
            event = service.events().insert(calendarId='nts82p92nj4512rco570kfdnj8@group.calendar.google.com', body=event).execute()
